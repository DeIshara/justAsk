...
<body>
    <div class="container">
        ...
        <?php
            ...
            $sq="SELECT * FROM driver WHERE status=0";
            $result=$conn->query($sq);

            while ($row=$result->fetch_assoc()) {
                echo "<div class='row userlist'>
                        <div class='col-md-6'>
                                ...
                                <div class='col-md-6 deletebtnholder'>
                                    <form action='includes/requestAccept.include.php' method='POST'>
                                        <input type='hidden' name='driverId' value='".$row['driverId']."'>
                                        <button class='acceptbtn'>Accept</button>
                                    </form>
                                    <form action='includes/requestDelete.include.php' method='POST'>
                                        <input type='hidden' name='driverId' value='".$row['driverId']."'>
